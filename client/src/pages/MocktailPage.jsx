...
const MocktailPage = () => {
    ...
    useEffect(() => {
        const fetchRecipes = async () => {
            setLoading(true);
            try {
                const response = await getRecipes(searchTerm, 'Mocktail', {}, 1, 100);
                ...
                console.error('Error fetching mocktail recipes:', error);
                setRecipes([]);
            } finally {
                setLoading(false);
            }
    ...
    return (
        <div className="min-h-screen pb-20 pt-8">
            ...
            >
                ...
                >
                    <div className="p-4 bg-gradient-to-br from-gold-400 to-gold-500 rounded-full text-white shadow-2xl">
                        <GlassWater size={40} />
                    </div>
                </motion.div>
                <h1 className="text-5xl md:text-6xl font-serif font-bold mb-4 bg-gradient-to-r from-gold-500 to-gold-400 bg-clip-text text-transparent">
                    Mocktail Collection
                </h1>
                <p className="text-xl text-espresso-800/70 max-w-2xl mx-auto">
                    Refreshing non-alcoholic beverages for every occasion
                </p>
            </motion.header>
            ...
            <section className="max-w-4xl mx-auto px-6 mb-12">
                ...
                >
                    ...
                    <input
                        type="text"
                        placeholder="Search mocktail recipes..."
                        value={searchTerm}
            ...
            <main className="max-w-7xl mx-auto px-6">
                <AnimatePresence mode="wait">
                    {loading ? (
                        ...
                        >
                            <GlassWater size={64} className="text-espresso-800/20 mx-auto mb-6" />
                            <h3 className="text-2xl font-serif font-semibold text-espresso-900 mb-3">
                                No mocktail recipes found
                            </h3>
