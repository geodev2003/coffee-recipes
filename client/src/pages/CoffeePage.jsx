...
const CoffeePage = () => {
    ...
    useEffect(() => {
        const fetchRecipes = async () => {
            setLoading(true);
            try {
                const response = await getRecipes(searchTerm, 'Coffee', {}, 1, 100);
                ...
                console.error('Error fetching coffee recipes:', error);
                setRecipes([]);
            } finally {
                setLoading(false);
            }
    ...
    return (
        <div className="min-h-screen pb-20 pt-8">
            ...
            >
                ...
                >
                    <div className="p-4 bg-gradient-coffee rounded-full text-white shadow-2xl">
                        <Coffee size={40} />
                    </div>
                </motion.div>
                <h1 className="text-5xl md:text-6xl font-serif font-bold mb-4 bg-gradient-coffee bg-clip-text text-transparent">
                    Coffee Collection
                </h1>
                <p className="text-xl text-espresso-800/70 max-w-2xl mx-auto">
                    Discover the art of perfect coffee brewing with our curated selection
                </p>
            </motion.header>
            ...
            <main className="max-w-7xl mx-auto px-6">
                <AnimatePresence mode="wait">
                    {loading ? (
                        ...
                        >
                            <Coffee size={64} className="text-espresso-800/20 mx-auto mb-6" />
                            <h3 className="text-2xl font-serif font-semibold text-espresso-900 mb-3">
                                No coffee recipes found
                            </h3>
