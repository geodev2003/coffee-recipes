...
import { Coffee, LogIn, Lock, User, Mail } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response && response.success) {
        ...
        // Redirect based on where they came from or to home
      ...
      >
        <div className="glass-card p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-coffee-600/70">Sign in to your account</p>
          </div>
          ...
          <div className="mt-6 space-y-3 text-center">
            <p className="text-sm text-coffee-600/70">
              ...
              <Link to="/register" className="text-forest-800 hover:text-forest-900 font-semibold transition-colors">
                Sign up
              </Link>
            </p>
